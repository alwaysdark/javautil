package com.navinfo.rainbow.ai.fileupload;

import com.navinfo.rainbow.common.util.DateUtil;
 ...
 * Package: 
 * @Author: lifan
 * @Date: Created in 2020/4/20 14:57
 * @Description:
 **************************************/
public class GroupFileView extends JFrame {
    ...
    private String fileIconPath = "C:\\Users\\lifan6847\\Desktop\\工作文档\\oracle-java.jpg";
    ...
    private void renderTop() {
        ...
        flushLabel = new JLabel(new ImageIcon("C:\\Users\\lifan6847\\Desktop\\工作文档\\file-banner.png"));
            ...
            public void run() {
                try {
                    ...
                    if (this.mode == 1) {
                        ...
                        System.out.println("开始时间：" +  DateUtil.dateFromDateToStr(new Date(),"yyyy-MM-dd HH:mm:ss"));
                        ...
                        System.out.println("结束时间：" +  DateUtil.dateFromDateToStr(new Date(),"yyyy-MM-dd HH:mm:ss"));
                    }
